...
import com.osdb.pro.ui.dashboard.view.NewsFragment;
import com.osdb.pro.ui.player_details_screen.beans.PlayerDetailInfoBean;
import com.osdb.pro.ui.player_details_screen.beans.VideosBean;
import com.osdb.pro.ui.player_details_screen.presenter.PlayerDetailsPresenterClass;
import com.osdb.pro.ui.team_details_screen.beans.StatsBeanVertical;
import com.osdb.pro.ui.team_details_screen.view.StatsFragment;
...
public class PlayerDetailsActivity extends BaseActivity implements PlayerDetailsView, View.OnClickListener {
    ...
    private void setupViewPager(ViewPager upViewPager) {
        ...
        adapter.addFragment(NewsFragment.getInstance(playerName), getString(R.string.news));
