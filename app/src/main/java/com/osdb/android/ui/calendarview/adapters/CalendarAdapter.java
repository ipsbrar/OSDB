package com.osdb.android.ui.calendarview.adapters;
...
import com.osdb.android.ui.calendarview.data.Day;
import com.osdb.android.ui.calendarview.data.Month;
import com.osdb.android.ui.calendarview.data.WeekManager;
import com.osdb.android.ui.calendarview.holders.MonthHolder;
import com.osdb.android.ui.calendarview.view.CalendarView;
...
public class CalendarAdapter extends RecyclerView.Adapter<MonthHolder> {
    ...
    LinearLayout weekDayNames;

    private int PAYLOAD = 1; // o numero de meses que serao carregados antes e depois do mes atual.
...
//        weekDayNames.getLayoutParams().height = new CalendarView.Attributes().weekdayHeight;
...
//        }
    ...
    public void getPreviousMonth() {
            ...
            Log.e("Month", earlyYearLoaded + " " + PAYLOAD);
