...
import com.osdb.pro.ui.particular_sport_screen.adapters.TeamsViewAdapter;
import com.osdb.pro.ui.particular_sport_screen.beans.TeamClubBean;
import com.osdb.pro.ui.particular_sport_screen.presenter.TeamFragmentPresenterClass;
...
//        No data found Views
        ...
        teamsEpView.setOnGroupExpandListener(new ExpandableListView.OnGroupExpandListener() {
            @Override
            public void onGroupExpand(int groupPosition) {
                if (lastExpandedPosition != -1
                        && groupPosition != lastExpandedPosition) {
                    teamsEpView.collapseGroup(lastExpandedPosition);
                }
