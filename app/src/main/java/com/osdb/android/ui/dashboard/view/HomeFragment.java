...
import com.osdb.android.ui.dashboard.Interfaces.BornTodayOnClick;
import com.osdb.android.ui.dashboard.Interfaces.DoYouKnowOnClick;
import com.osdb.android.ui.dashboard.adapters.BornTodayAdapter;
import com.osdb.android.ui.dashboard.adapters.DoYouKnowAdapter;
import com.osdb.android.ui.dashboard.adapters.SportsListAdapter;
import com.osdb.android.ui.dashboard.beans.*;
import com.osdb.android.ui.dashboard.presenter.HomeFragmentPresenterClass;
import com.osdb.android.ui.detailview.view.DetailActivity;
import com.osdb.android.ui.do_you_know.view.DoYouKnowActivity;
import com.osdb.android.ui.particular_sport_screen.view.SportsActivity;
...
public class HomeFragment extends BaseFragment implements View.OnClickListener,
    ...
    private HomeFragmentPresenterClass<HomeFragment, com.osdb.android.ui.dashboard.model.HomeFragmentInteractor> homeFragmentPresenterClass;
    private TextView view_1_msg_text, view_4_msg_text, view_6_msg_text, view_1_time_stamp, view_1_date, view_1_game_name;
...
//            intent.putExtra("timeStamp", timeStamp);
    ...
    private void setBreakingNewsData(ArrayList<HomeBean.BreakingNews> breakingNews) {
        if (breakingNews != null && breakingNews.size() > 0) {
            ...
            view_1_game_name.setText(breakingNewsFrag.getSlug() != null ? breakingNewsFrag.getSlug() : "NFL");
        ...
        switch (v.getId()) {
            case R.id.rl_breaking_news: {
                if (breakingNewsFrag != null) {
                    ...
                    intent.putExtra("bigContent", breakingNewsFrag.getLongContent());
                    intent.putExtra("teamName", view_1_game_name.getText().toString().trim());
