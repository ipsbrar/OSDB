...
public class TableViewAdapter extends AbstractTableAdapter<String, String, String> {
    ...
    private DemoTableData mDemoTableData;
    private final LayoutInflater mInflater;
    private Context mContext;

    public TableViewAdapter(Context context, DemoTableData DemoTableData) {
        super(context);
        this.mContext = context;
        this.mDemoTableData = DemoTableData;
    ...
    public void onBindRowHeaderViewHolder(AbstractViewHolder holder, Object rowHeaderItemModel,
        ...
        rowHeaderViewHolder.row_header_textview.setText(String.valueOf(rowHeader));
    }
...
//        // type of CellViewHolder on "onCreateCellViewHolder"
//        switch (column) {
//            case DemoTableData.MOOD_COLUMN_INDEX:
//                return MOOD_CELL_TYPE;
//            case DemoTableData.GENDER_COLUMN_INDEX:
