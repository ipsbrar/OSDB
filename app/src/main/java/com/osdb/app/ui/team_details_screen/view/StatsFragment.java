...
import com.osdb.app.ui.DemoTable.MyTableViewAdapter;
...
import com.osdb.app.ui.team_details_screen.presenter.StatsPresenterClass;
...
//        context = getContext();
    ...
    private void setUpStatsLayout(ArrayList<StatsBeanVertical> verticalArrayList) {
        ...
        sv_stats.setVisibility(View.VISIBLE);
        no_data.setVisibility(View.GONE);
