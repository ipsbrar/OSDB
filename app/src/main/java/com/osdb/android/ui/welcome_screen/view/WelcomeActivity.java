package com.osdb.android.ui.welcome_screen.view;
...
public class WelcomeActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        prefManager = new AppPreferenceHelperClass(this);
        ...
        layouts = new int[]{
                R.layout.benifit_slide1,
                R.layout.benifit_slide2,
                R.layout.benifit_slide3};
