...
import com.osdb.app.ui.search_screen.adapters.SearchAdapter;
...
import com.osdb.app.ui.search_screen.model.SearchScreenInteractorClass;
import com.osdb.app.ui.search_screen.view.SearchActivity;
...
public class SearchScreenPresenterClass<V extends SearchScreenView, I extends SearchScreenInteractor>
    ...
    ArrayList<SearchAdapterRemoteBean> searchAdapterRemoteBeanArrayList;
    ...
    private void parseData(final SearchModal.data homeData) {
         searchAdapterRemoteBeanArrayList = new ArrayList<>();
            ...
            public void run() {
                ...
                if (homeData.getNewsArrayList() != null && homeData.getNewsArrayList().size() > 0) {
                    ...
                    for (int i = 0; i < homeData.getNewsArrayList().size(); i++) {
                        ...
                        String source = homeData.getNewsArrayList().get(i).getSource();
                        String slug = null;
                        ...
                        searchAdapterRemoteBean.setSource(source);
                        searchAdapterRemoteBean.setSearchType(SearchAdapter.ITEM_TYPE);
