...
public class ColumnHeaderViewHolder extends AbstractSorterViewHolder {
    ...
    public ColumnHeaderViewHolder(View itemView, ITableView tableView) {
        ...
        arrow_up = ContextCompat.getDrawable(itemView.getContext(), R.drawable.ic_share);
        arrow_down = ContextCompat.getDrawable(itemView.getContext(), R.drawable.ic_share);
    ...
    public void setColumnHeader(String columnHeader) {
        column_header_textview.setText(String.valueOf(columnHeader));
